...
from app.classes.data import Post, Comment, Therapist, Resource
from app.classes.forms import PostForm, CommentForm, TherapistForm, ResourceForm
...
def postEdit(postID):
    ...
    form.exclass.data = editPost.exclass
